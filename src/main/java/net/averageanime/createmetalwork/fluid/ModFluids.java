...
public class ModFluids {
    ...
    public static void registerFluid() {
        ...
        if (FabricLoader.getInstance().isModLoaded("betterend")) {
            ...
            ItemGroupEvents.modifyEntriesEvent(CreateMetalwork.GROUP).register(entries -> entries.add(MOLTEN_THALLASIUM_BUCKET));
            STILL_MOLTEN_THALLASIUM = Registry.register(Registries.FLUID,
                    new Identifier(CreateMetalwork.MOD_ID, "molten_thallasium"), new MoltenThallasiumFluid.Still());
            FLOWING_MOLTEN_THALLASIUM = Registry.register(Registries.FLUID,
                    new Identifier(CreateMetalwork.MOD_ID, "flowing_molten_thallasium"), new MoltenThallasiumFluid.Flowing());
            MOLTEN_THALLASIUM_BLOCK = Registry.register(Registries.BLOCK, new Identifier(CreateMetalwork.MOD_ID, "molten_thallasium_block"),
                    new FluidBlock(ModFluids.STILL_MOLTEN_THALLASIUM, FabricBlockSettings.copyOf(Blocks.LAVA)) {
                    });
            MOLTEN_THALLASIUM_BUCKET = Registry.register(Registries.ITEM, new Identifier(CreateMetalwork.MOD_ID, "molten_thallasium_bucket"),
                    new BucketItem(ModFluids.STILL_MOLTEN_THALLASIUM, new FabricItemSettings().recipeRemainder(Items.BUCKET).maxCount(1)));

            ItemGroupEvents.modifyEntriesEvent(CreateMetalwork.GROUP).register(entries -> entries.add(MOLTEN_TERMINITE_BUCKET));
            STILL_MOLTEN_TERMINITE = Registry.register(Registries.FLUID,
                    new Identifier(CreateMetalwork.MOD_ID, "molten_terminite"), new MoltenTerminiteFluid.Still());
            FLOWING_MOLTEN_TERMINITE = Registry.register(Registries.FLUID,
                    new Identifier(CreateMetalwork.MOD_ID, "flowing_molten_terminite"), new MoltenTerminiteFluid.Flowing());
            MOLTEN_TERMINITE_BLOCK = Registry.register(Registries.BLOCK, new Identifier(CreateMetalwork.MOD_ID, "molten_terminite_block"),
                    new FluidBlock(ModFluids.STILL_MOLTEN_TERMINITE, FabricBlockSettings.copyOf(Blocks.LAVA)) {
                    });
            MOLTEN_TERMINITE_BUCKET = Registry.register(Registries.ITEM, new Identifier(CreateMetalwork.MOD_ID, "molten_terminite_bucket"),
                    new BucketItem(ModFluids.STILL_MOLTEN_TERMINITE, new FabricItemSettings().recipeRemainder(Items.BUCKET).maxCount(1)));

            ItemGroupEvents.modifyEntriesEvent(CreateMetalwork.GROUP).register(entries -> entries.add(MOLTEN_AETERNIUM_BUCKET));
            STILL_MOLTEN_AETERNIUM = Registry.register(Registries.FLUID,
                    new Identifier(CreateMetalwork.MOD_ID, "molten_aeternium"), new MoltenAeterniumFluid.Still());
            FLOWING_MOLTEN_AETERNIUM = Registry.register(Registries.FLUID,
                    new Identifier(CreateMetalwork.MOD_ID, "flowing_molten_aeternium"), new MoltenAeterniumFluid.Flowing());
            MOLTEN_AETERNIUM_BLOCK = Registry.register(Registries.BLOCK, new Identifier(CreateMetalwork.MOD_ID, "molten_aeternium_block"),
                    new FluidBlock(ModFluids.STILL_MOLTEN_AETERNIUM, FabricBlockSettings.copyOf(Blocks.LAVA)) {
                    });
            MOLTEN_AETERNIUM_BUCKET = Registry.register(Registries.ITEM, new Identifier(CreateMetalwork.MOD_ID, "molten_aeternium_bucket"),
                    new BucketItem(ModFluids.STILL_MOLTEN_AETERNIUM, new FabricItemSettings().recipeRemainder(Items.BUCKET).maxCount(1)));

        }

        if (FabricLoader.getInstance().isModLoaded("betternether")) {
            ItemGroupEvents.modifyEntriesEvent(CreateMetalwork.GROUP).register(entries -> entries.add(MOLTEN_CINCINNASITE_BUCKET));
            STILL_MOLTEN_CINCINNASITE = Registry.register(Registries.FLUID,
                    new Identifier(CreateMetalwork.MOD_ID, "molten_cincinnasite"), new MoltenCincinnasiteFluid.Still());
            FLOWING_MOLTEN_CINCINNASITE = Registry.register(Registries.FLUID,
                    new Identifier(CreateMetalwork.MOD_ID, "flowing_molten_cincinnasite"), new MoltenCincinnasiteFluid.Flowing());
            MOLTEN_CINCINNASITE_BLOCK = Registry.register(Registries.BLOCK, new Identifier(CreateMetalwork.MOD_ID, "molten_cincinnasite_block"),
                    new FluidBlock(ModFluids.STILL_MOLTEN_CINCINNASITE, FabricBlockSettings.copyOf(Blocks.LAVA)) {
                    });
            MOLTEN_CINCINNASITE_BUCKET = Registry.register(Registries.ITEM, new Identifier(CreateMetalwork.MOD_ID, "molten_cincinnasite_bucket"),
